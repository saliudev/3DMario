...
function Start 					() {												// initialize everything
	...
	animation.wrapMode 					 = WrapMode.Loop;							// set play animation mode to loop
...
function Attack 				() {												// attack mode
	...
	animation.Play ( "run" );														// play animation run
	...
	animation.CrossFade ( "idle" );													// now we can go back to playing the idle animation
}
function ApplyDamage 			() {												// play death animation
	animation.CrossFade ( "die" );													// animation die	
